...
class InviteFrontCard extends StatefulWidget {
  ...
  const InviteFrontCard(
      ...
      : super(key: key);
  @override
  _InviteFrontCardState createState() => _InviteFrontCardState();
}

class _InviteFrontCardState extends State<InviteFrontCard> {
